...
const Navbar = () => {
  ...
  useEffect(() => {
    // Fetches auth providers using getProviders() and saves them in state via setProviders().
    ...
    <nav className='bg-blue-700 border-b border-blue-500'>
      <div className='mx-auto max-w-7xl px-2 sm:px-6 lg:px-8'>
        <div className='relative flex h-20 items-center justify-between'>
          ...
          {/* That line checks if providers exists, then loops through all the providers using Object.values(providers).
          For each provider, it renders a login button that calls signIn(provider.id) when clicked—this triggers login
          via that specific provider (like Google). */}
          {!session && (
